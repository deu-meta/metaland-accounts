...
from mtl_accounts.models import Minecraft, User
from sqlalchemy.orm import Session


def create_users(session: Session, user: User) -> Users:
...
def create_mincraft(session: Session, minecraft: Minecraft, mail: str) -> Minecraft_Account:
